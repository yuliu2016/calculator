...
public class FugaRules {
    ...
    public static final ParserRule INVOCATION = and_rule("invocation");
    public static final ParserRule CALL_ARG_LIST = and_rule("call_arg_list");
    public static final ParserRule CALL_ARG = or_rule("call_arg");
    public static final ParserRule CALL_ARG_1 = and_rule("call_arg:1");
    public static final ParserRule CALL_ARG_2 = and_rule("call_arg:2");
    public static final ParserRule CALL_ARG_3 = and_rule("call_arg:3");
    public static final ParserRule CALL_ARG_4 = and_rule("call_arg:4");
    ...
    public static final ParserRule SIMPLE_ARGS = and_rule("simple_args");
