...
public class FugaRules {
    ...
    public static final ParserRule SIMPLE_ARG_LIST_2 = and_rule("simple_arg_list:2");
    ...
    public static final ParserRule DISJUNCTION = and_rule("disjunction");
    public static final ParserRule DISJUNCTION_2 = and_rule("disjunction:2");
    public static final ParserRule CONJUNCTION = and_rule("conjunction");
    public static final ParserRule CONJUNCTION_2 = and_rule("conjunction:2");
    ...
    public static final ParserRule COMPARISON = and_rule("comparison");
    public static final ParserRule COMPARISON_2 = and_rule("comparison:2");
    ...
    public static final ParserRule BITWISE_OR = and_rule("bitwise_or");
    public static final ParserRule BITWISE_OR_2 = and_rule("bitwise_or:2");
    public static final ParserRule BITWISE_XOR = and_rule("bitwise_xor");
    public static final ParserRule BITWISE_XOR_2 = and_rule("bitwise_xor:2");
    public static final ParserRule BITWISE_AND = and_rule("bitwise_and");
    public static final ParserRule BITWISE_AND_2 = and_rule("bitwise_and:2");
    public static final ParserRule SHIFT_OP = or_rule("shift_op");
    public static final ParserRule SHIFT_EXPR = and_rule("shift_expr");
    public static final ParserRule SHIFT_EXPR_2 = and_rule("shift_expr:2");
    public static final ParserRule SUM_OP = or_rule("sum_op");
    public static final ParserRule SUM = and_rule("sum");
    public static final ParserRule SUM_2 = and_rule("sum:2");
    public static final ParserRule TERM_OP = or_rule("term_op");
    public static final ParserRule TERM = and_rule("term");
    public static final ParserRule TERM_2 = and_rule("term:2");
    public static final ParserRule PIPELINE = and_rule("pipeline");
    public static final ParserRule PIPELINE_2 = and_rule("pipeline:2");
