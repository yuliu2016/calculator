...
public class CalculatorGenerator {
    ...
    private static final Path GRAMMAR_PATH = Paths.get(USER_DIR, "src/main/files/CalculatorGrammar");
    private static final Path OUTPUT_PATH = Paths.get(USER_DIR,
            "src/main/gen/org/fugalang/core/calculator/pgen/");
    private static final String PACKAGE_NAME = "org.fugalang.core.calculator.pgen";
